...
bot:
	cd build && make -j8 && ./run_zmq_image_slam -v orb_vocab.dbow2 -c ../../dataset/fisheye.640x480.aspersp.config.yaml --mask ../../dataset/mask2.png # --map-db-in map1.msg  --map-db-out map2.msg

bot_picam:
	cd build && make -j8 && ./run_zmq_image_slam -v orb_vocab.dbow2 -c ../../dataset/picam640x480.yaml  # --map-db-in map1.msg  --map-db-out map2.msg
